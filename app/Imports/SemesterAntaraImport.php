...
class SemesterAntaraImport implements ToCollection, WithHeadingRow
{
    /**
    ...
    public function collection(Collection $collection)
    {
        foreach ($collection as $row) {
            ...
            $dokumen = trim($row['dokumen'] ?? $row['dkumen'] ?? $row['link_dokumen'] ?? $row['link'] ?? $row['url'] ?? '');
