...
class SkPengujiSemproDataTable extends DataTable
{
    /**
     * Build the DataTable class.
     *
     * @param QueryBuilder<SkPengujiSempro> $query Results from query() method.
     */
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($item) {
                ...
                $editUrl = route('skpengujisempro.edit', $item->id);
                $deleteUrl = route('skpengujisempro.destroy', $item->id);
                $csrf = csrf_field();
     ...
     *
     * @return QueryBuilder<SkPengujiSempro>
     */
    public function query(SkPengujiSempro $model): QueryBuilder
    {
        $query = $model->newQuery()
            ->select('sk_penguji_sempros.*')
            ->with(['tahunakademik', 'users'])
            ->latest('sk_penguji_sempros.created_at');
    ...
    {
        return $this->builder()
                    ->setTableId('skpengujisempro-table')
    ...
    {
        return 'SkPengujiSempro_' . date('YmdHis');
    }
}
