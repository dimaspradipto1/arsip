...
class SkPengangkatanStrukturalDataTable extends DataTable
{
     ...
     *
     * @param QueryBuilder<SkPengangkatanStruktural> $query Results from query() method.
     */
     ...
     *
     * @return QueryBuilder<SkPengangkatanStruktural>
     */
    ...
    {
        return $this->builder()
                    ->setTableId('skpengangkatanstruktural-table')
    ...
    {
        return 'SkPengangkatanStruktural_' . date('YmdHis');
    }
}
