            ...
            <div class="col-12 col-lg-8 col-xl-6">
                <div class="card mt-2 mt-md-3 shadow-sm border-radius-lg">
                    <div class="card-header pb-0 p-3 bg-transparent border-bottom">
                        <h6 class="mb-0 font-weight-bolder text-dark">Form Tambah Tahun Akademik</h6>
                    </div>
                    <div class="card-body p-3 p-md-4">
                        <form action="{{ route('tahunakademik.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tahun_akademik" id="tahun_akademik" value="{{ old('tahun_akademik') }}" class="form-control" placeholder="Contoh: 2025/2026 Ganjil" required>
