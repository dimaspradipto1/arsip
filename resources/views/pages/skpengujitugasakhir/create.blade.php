...
@section('title', 'Tambah SK Penguji Tugas Akhir')
            ...
            <div class="col-12">
                <div class="card mt-2 mt-md-3 shadow-sm border-radius-lg">
                    <div class="card-header pb-0 p-3 bg-transparent border-bottom">
                        <h6 class="mb-0 font-weight-bolder text-dark">Form Tambah SK Penguji Tugas Akhir</h6>
                    </div>
                    <div class="card-body p-3 p-md-4">
                        <form action="{{ route('skpengujitugasakhir.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="nama_mahasiswa" id="nama_mahasiswa" value="{{ old('nama_mahasiswa') }}" class="form-control" placeholder="Masukkan nama mahasiswa" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="npm" id="npm" value="{{ old('npm') }}" class="form-control" placeholder="Masukkan NPM mahasiswa" required>
                                    @error('npm')
                                        <div class="text-danger text-xs mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="tanggal_sk" id="tanggal_sk" value="{{ old('tanggal_sk', date('Y-m-d')) }}" class="form-control" required>
                                @error('tanggal_sk')
                                    <div class="text-danger text-xs mt-1">{{ $message }}</div>
                                @enderror
                            </div>
