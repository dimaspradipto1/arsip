        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Tambah SK Panitia</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Tambah SK Panitia</h6>
            </nav>
        </div>
    </nav>
    <!-- End Navbar -->
                            ...
                            <div class="card-header pb-0 p-3">
                                <div class="row">
                                    <div class="col-6 d-flex align-items-center">
                                        <h6 class="mb-0">Form Tambah SK Panitia</h6>
                                    </div>
                                ...
                                <div class="row">
                                    <form action="{{ route('skkepanitiaan.store') }}" method="POST">
                                        ...
                                        <div class="col-md-8 mb-md-0 mb-4">
                                            ...
                                            <input type="text" name="nomor_sk" value="{{ old('nomor_sk') }}" class="form-control">
                                            @error('nomor_sk')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-8 mb-md-0 mb-4">
                                           ...
                                           <textarea name="dokumen" id="dokumen" class="form-control">{{ old('dokumen') }}</textarea>
                                            @error('dokumen')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
