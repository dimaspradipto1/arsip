...
@section('title', 'Tambah SK Pengangkatan Struktural')
            ...
            <div class="col-12">
                <div class="card mt-2 mt-md-3 shadow-sm border-radius-lg">
                    <div class="card-header pb-0 p-3 bg-transparent border-bottom">
                        <h6 class="mb-0 font-weight-bolder text-dark">Form Tambah SK Pengangkatan Struktural</h6>
                    </div>
                    <div class="card-body p-3 p-md-4">
                        <form action="{{ route('skpengangkatanstruktural.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="masa_jabatan" id="masa_jabatan" value="{{ old('masa_jabatan') }}" class="form-control" placeholder="Masukkan masa jabatan (contoh: 2024 - 2028)" required>
                                @error('masa_jabatan')
                                    <div class="text-danger text-xs mt-1">{{ $message }}</div>
                                @enderror
                            </div>
