...
@section('title', 'Edit Kategori SK')
            ...
            <div class="col-12 col-lg-8 col-xl-6">
                <div class="card mt-2 mt-md-3 shadow-sm border-radius-lg">
                    <div class="card-header pb-0 p-3 bg-transparent border-bottom">
                        <h6 class="mb-0 font-weight-bolder text-dark">Form Edit Kategori SK</h6>
                    </div>
                    <div class="card-body p-3 p-md-4">
                        <form action="{{ route('kategorysk.update', $kategorysk->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="kategory_sk" id="kategory_sk" value="{{ old('kategory_sk', $kategorysk->kategory_sk) }}" class="form-control" required>
                                @error('kategory_sk')
