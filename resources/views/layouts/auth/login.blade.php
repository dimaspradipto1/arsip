...
<head>
    ...
    <link href="{{ asset('dashboard/assets/css/nucleo-svg.css') }}" rel="stylesheet" />
    <!-- CSS Files -->
    <link id="pagestyle" href="dashboard/assets/css/soft-ui-dashboard.css?v=1.0.3" rel="stylesheet" />
</head>
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    {{-- <nav
        ...
        <div class="container">
            <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white"
                href="dashboard/assets/pages/dashboards/default.html">
                Arsip Fakultas Sains dan Teknologi
            </a>
                ...
                <ul class="navbar-nav navbar-nav-hover mx-auto">
                    <li class="nav-item dropdown dropdown-hover mx-2">
                        <a role="button"
                            ...
                            Pages
                            <img src=" {{ asset('dashboard/assets/img/down-arrow-dark.svg') }} " alt="down-arrow"
    ...
    <section class="min-vh-100 mb-8">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
            style="background-image: url('dashboard/assets/img/gedung.jpg');">
            ...
            <div class="row mt-lg-n10 mt-md-n11 mt-n10">
                <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form action="{{ route('loginproses') }}" method="POST" role="form text-left">
                                @csrf
                                <div class="mb-3">
