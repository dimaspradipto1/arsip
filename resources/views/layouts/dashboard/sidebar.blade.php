...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="sidenav-header position-relative">
        ...
        <a class="navbar-brand m-0 d-flex align-items-center" href="{{ route('dashboard') }}">
            ...
            <span class="font-weight-bold text-dark text-uppercase"
                style="font-size: 0.95rem; letter-spacing: 0.5px;">E-Arsip UIS</span>
        </a>
    </div>
    ...
    <div class="collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('identitaskaryailmiah*') ? 'active' : '' }}"
                    href="{{ route('identitaskaryailmiah.index') }}">
                    <div class="menu-icon-box">
            ...
            <li class="nav-item">
                ...
                <div class="collapse {{ $isPendidikanActive ? 'show' : '' }}" id="collapsePendidikan">
                    <ul class="sidebar-submenu">
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('skpengajaran*') ? 'active' : '' }}"
                                href="{{ route('skpengajaran.index') }}">
                                <i class="fas fa-chalkboard-user"></i> SK Pengajaran
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('skpembimbingakademik*') ? 'active' : '' }}"
                                href="{{ route('skpembimbingakademik.index') }}">
                                <i class="fas fa-user-graduate"></i> SK Pembimbing Akademik
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('skpembimbingkpm*') ? 'active' : '' }}"
                                href="{{ route('skpembimbingkpm.index') }}">
                                <i class="fas fa-hand-holding-heart"></i> SK Pembimbing KPM
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('skpembimbingtugasakhir*') ? 'active' : '' }}"
                                href="{{ route('skpembimbingtugasakhir.index') }}">
                                <i class="fas fa-file-pen"></i> SK Pembimbing TA
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('skpengujisempro*') ? 'active' : '' }}"
                                href="{{ route('skpengujisempro.index') }}">
                                <i class="fas fa-list-check"></i> SK Penguji Sempro
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('skpengujitugasakhir*') ? 'active' : '' }}"
                                href="{{ route('skpengujitugasakhir.index') }}">
            ...
            <li class="nav-item">
                ...
                <div class="collapse {{ $isPenelitianActive ? 'show' : '' }}" id="collapsePenelitian">
                    <ul class="sidebar-submenu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('hki*') ? 'active' : '' }}"
                                href="{{ route('hki.index') }}">
                                <i class="fas fa-shield-halved"></i> HKI
                            </a>
                        </li>
                        <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div class="collapse {{ $isPenunjangActive ? 'show' : '' }}" id="collapsePenunjang">
                    <ul class="sidebar-submenu">
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('skkepanitiaan*') ? 'active' : '' }}"
                                href="{{ route('skkepanitiaan.index') }}">
            ...
            @if (auth()->check() && auth()->user()->roles !== 'dosen')
                ...
                @php
                    $isLpjActive = request()->routeIs('bebankerjadosen*', 'semesterantara*', 'kuliahpengabdianmasyarakat*', 'karturencanaStudi*', 'ujiantengahsemester*', 'ujianakhirsemester*', 'yudisium*');
                @endphp
                <li class="nav-item">
                    ...
                    <div class="collapse {{ $isLpjActive ? 'show' : '' }}" id="collapseLPJ">
                        <ul class="sidebar-submenu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('kuliahpengabdianmasyarakat*') ? 'active' : '' }}"
                                    href="{{ route('kuliahpengabdianmasyarakat.index') }}">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('ujianakhirsemester*') ? 'active' : '' }}"
                                    href="{{ route('ujianakhirsemester.index') }}">
                                    <i class="fas fa-file-signature"></i> Ujian Akhir Semester (UAS)
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('yudisium*') ? 'active' : '' }}"
                                    href="{{ route('yudisium.index') }}">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse {{ $isMasterActive ? 'show' : '' }}" id="collapseMasterData">
                        <ul class="sidebar-submenu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('tahunakademik*') ? 'active' : '' }}"
                                    href="{{ route('tahunakademik.index') }}">
                                    <i class="fas fa-calendar-days"></i> Tahun Akademik
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('kategorysk*') ? 'active' : '' }}"
                                    href="{{ route('kategorysk.index') }}">
        ...
        <div class="sidenav-footer mx-3 mt-4 mb-3">
            <div class="card card-background shadow-none card-background-mask-secondary border-radius-lg"
                id="sidenavCard">
                <div class="full-background"
                    style="background-image: url('{{ asset('dashboard/assets/img/curved-images/white-curved.jpeg') }}')">
                </div>
